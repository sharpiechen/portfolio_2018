...
<div class="post__casestudy">
    ...
    <a href="#img3i">
        <img src="{{site.baseurl}}/assets/img-asset-3i.png" alt="image" class="post__asset">
    </a>
	<a href="#_" class="post__lightbox" id="img3i">
        <p class="post__lightbox__close">&#x2715;</p>
        <img src="{{site.baseurl}}/assets/img-asset-3i.png">
    </a>
	<p>
    ...
    <a href="#img3j">
        <img src="{{site.baseurl}}/assets/img-asset-3j.png" alt="image" class="post__asset">
    </a>
	<a href="#_" class="post__lightbox" id="img3j">
        <p class="post__lightbox__close">&#x2715;</p>
        <img src="{{site.baseurl}}/assets/img-asset-3j.png">
    </a>
    <a href="#img3k">
        <img src="{{site.baseurl}}/assets/img-asset-3k.png" alt="image" class="post__asset">
    </a>
	<a href="#_" class="post__lightbox" id="img3k">
        <p class="post__lightbox__close">&#x2715;</p>
        <img src="{{site.baseurl}}/assets/img-asset-3k.png">
    </a> 
