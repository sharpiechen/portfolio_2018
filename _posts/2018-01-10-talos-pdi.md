...
<div class="post__casestudy">
	...
	<a href="#_" class="post__lightbox" id="img3j">
        <p class="post__lightbox__close">&#x2715;</p>
        <img src="{{site.baseurl}}/assets/img-asset-3j.jpg">
    </a>
    <a href="#img3k">
        <img src="{{site.baseurl}}/assets/img-asset-3k.jpg" alt="image" class="post__asset">
    </a>
	<a href="#_" class="post__lightbox" id="img3k">
        <p class="post__lightbox__close">&#x2715;</p>
        <img src="{{site.baseurl}}/assets/img-asset-3k.jpg">
    </a> 
